angular.module('appModule').controller('projectBrowserController', ['$scope', '$window', '$rootScope', 'showProjectNameInput', 'projectService', '$modalInstance', 'surfToastr', '$modal', 'mapService', 'dirtyManager', 'urlResolver', 'subscriptionStatus', 'helperService', '$http',
